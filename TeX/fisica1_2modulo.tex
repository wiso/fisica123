...
\begin{equation*}V_\text{totale}-V_\text{emergente}=V_\text{totale}\frac{\rho_\text{ghiaccio}}{\rho_\text{\ce{H2O}}}\end{equation*}
...
Segue che le superficie isobariche \index{superficie!isobarica}coincidono con le superfici equipotenziali. Nel caso agisca solo la forza peso esse sono dei piani orizzontali.
\end{Es}
...
\begin{equation*}PVV^{\gamma-1}=\const\end{equation*}
\begin{equation}
