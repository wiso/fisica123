...
Chiamiamo $\media{K}$ antikelvin un ciclo che viola Kelvin e $\media{C}$ anticlausius un ciclo che viola Clausius. Dimostriamo che $(\exists\media{K}\Rightarrow\exists\media{C})\wedge(\exists\media{C}\Rightarrow\exists\media{K})$
...
\begin{Cor}
Se la macchina è reversibile $\eta_M=\eta_C$. Per assurdo $\eta_M<\eta_C$, $M^{-1}+C=\media{C},$ assurdo $\Rightarrow \eta_M\geq\eta_C\Rightarrow \eta_M=\eta_C$
\end{Cor}
